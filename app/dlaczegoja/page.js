    ...
    <>
      ...
      <div className="pt-14 pb-4 px-8">
        <div className="h-max text-center">
          <h1 className="heroh1 mb-2">Dlaczego ja</h1>
          <h2 className="heroh2">
        ...
        <div className="container whyme-section">
          ...
          <div className="whyme-section1-boxes">
            <div className="whyme-section1-box">
              ...
              <p>
                <HiCheck />
                Ponad 80% klientów sprawdza firmę online, zanim zdecyduje się na
                kontakt. Jeśli Twoja firma nie ma strony internetowej,
        ...
        <div className="container whyme-section">
          ...
          <p>
            ...
            wydatek, ale w rzeczywistości jest to najskuteczniejsza inwestycja w
            rozwój biznesu.
          </p>
        ...
        <div className="container whyme-section">
          <h2>Technologie, których używam - nowoczesność i wydajność</h2>
          <p>
          ...
          <div>
            ...
            <h3>TypeScript</h3>
            <p>
              stabilny i bezbłędny kod, co przekłada się na niezawodność strony
            </p>
          </div>
          <h4>
