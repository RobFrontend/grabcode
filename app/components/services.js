          ...
          <div className="services-box">
            <div className="service">
              ...
              <ul>
                ...
                <li>
                  -Minimalistyczny design z silnym wezwaniem do działania (CTA)
                </li>
                <li>
          ...
          <div className="services-box">
            <div className="service">
              ...
              <p>
                ...
                treścią (CMS), które pozwalają Ci publikować i edytować wpisy z
                łatwością.
              </p>
              <ul>
          ...
          <div className="services-box">
            <div className="service">
              ...
              <p>
                ...
                customowych funkcji dostosowanych do Twoich potrzeb biznesowych.
              </p>
              <ul>
                <li>
                  -Wdrażanie integracji z zewnętrznymi platformami (np. Spotify,
                  Google Maps)
                </li>
